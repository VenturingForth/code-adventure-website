...
export default function Page(){
    return (
        <>
            ...
            <NavBar />
            <main>
                <h1>Curriculum Vitae of Joshua Robinson</h1>
                ...
                <section>
                    ...
                    <p>13 weeks of coding full stack web development with a focus on JavaScript, TDD, SQL and React. Paired programming was common practice as well as reading and writing technical documentation. Summed up with a group project phase where a mobile coding kata app  was designed and delivered over three weeks.</p>
                    <h3>Video Engineer, Clockwork Dreams</h3>
                    <time>February 2019 to November 2023</time>
                    <p>Provided video conferencing and webcasting solutions to the corporate events sector. Project highlights included the design, documentation and implementation of virtual courtroom solutions during the pandemic.</p>
                    <h3>Audio Visual Manager, She's Gott It Events</h3>
                    <time>May 2017 to January 2019</time>
                    <p>Technical production management of events including crew and equipment logistics. Delivered creative solutions for a variety of live events under tight budgetary constraints and short turnarounds.</p>
                    <h3>Freelance Audio Visual Technician, United Kingdom & Australia</h3>
                    <time>November 2010 to April 2017</time>
                    <p>Technical production expertise was provided in the fields of camera operation, projection and display setup, broadcast mixing and video editing for live events and in-house meeting room support in London and Sydney.</p>
                </section>
                <section>
                    <h2>Education</h2>
